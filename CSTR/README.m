...
%1. Open MATLAB and set the working directory to:
   ...
   %CSTR/MHE/state/ OR CSTR/EKF/state/ does not matter which on to open first just maintain directory
  
%2. Open `NMPC_CSTR.m` and run the script.
...
%2. Change the **Stop Time** (top toolbar) to: 30
