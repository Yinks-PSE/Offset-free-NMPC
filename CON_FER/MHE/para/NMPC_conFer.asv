...
nlobj.PredictionHorizon = 15; % Increased for better long-term prediction
...
nlobj.Weights.ManipulatedVariablesRate = 1; %0.1; % Reduced to improve responsiveness
...
%nlobj.Optimization.OutputOptimizationResults = 'on';
