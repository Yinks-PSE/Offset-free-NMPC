...
nlobj.Weights.OutputVariables = 500; % Balanced weight for faster tracking %0.1
nlobj.Weights.ManipulatedVariables = 0.01; % Increased to reduce control effort penalty %0.05;
nlobj.Weights.ManipulatedVariablesRate = 0.1; % Reduced to improve responsiveness


%constraints on manipulated variables
nlobj.MV(1).RateMin = -0.001;

nlobj.MV(1).RateMax = 0.001;
